...
const messages = [
  ['What-s-up!', 'Yo!', 'Hi ya!', 'Howdy-do!', 'Hi!', 'Hey!', 'Shalom!.', 'Bonjour!'],
  ['We', 'Individually', 'Personally,', 'Our own selves', 'Without help,', 'I'],
  ['would like to', 'would be delighted to', 'would be glad to', 'would be happy to', 'would be much more obliged to', 'would prefer to', 'would be cheerful to ', 'would be lucky to', 'would be favourable to', 'would be advategeous to'],
  ['warmly welcome you to Hobby Lab!.', 'heartly welcome you to Hobby Lab!', 'cheefully welcome you to Hobby Lab!', 'cordially welcome you to Hobby Lab!', 'genially welcome you to Hobby Lab!', 'convivialy welcome you to Hobby Lab!']
];
